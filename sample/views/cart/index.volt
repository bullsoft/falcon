	...
	<div class="goods-list-box">
	  <div class="goods-list-div" id="goods-list">
	    ...
	    <div class="goods-info clearfix" id='goods-list-{{item["id"]}}'>
	      <div class="" id="goods-sequence-box">
		...
		<div class="p-detail">
		  <p class="name">
		    <a target="_blank"  href="{{url('sample/goods/detail/')}}{{item['id']}}"> {{ item['name'] }} </a>
		  </p>
		</div>
	      </div>
	      <div class="merchant">
		...
		<a class="ms-button ms-button-normal settle-accounts" href="{{url('sample/cart/order')}}">
		  去结算
		</a>
	      </div>
	    </div>
