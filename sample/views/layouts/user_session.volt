...
<div class="nav-user clearfix">
  ...
  <div class="cell shopping-cart uk-parent" data-uk-dropdown="">
	...
	<div class="shopping-cart-total">
	  <div class="shopping-cart-total-tip">共<span class="total-count">{{ global_cart_num }}</span>件商品，共计<span class="total-price uk-icon-jpy">{{ array_sum(global_cart_totals) }}</span></div>
	  <a class="ck-btn" href="{{url('sample/cart/order')}}">去购物车结算</a>
	</div>
      </div>
    </div>
  </div>
