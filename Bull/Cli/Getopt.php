...
class Bull_Cli_Getopt
{
    ...
    {
        $this->option_factory = new Bull_Cli_OptionFactory();
    }
    ...
    public function getOption($prop)
    {
        ...
        if ($this->strict) {
            throw new Bull_Cli_Exception_OptionNotDefined($prop);
        }
    }
    ...
    public function getLongOption($long)
    {
        ...
        if ($this->strict) {
            throw new Bull_Cli_Exception_OptionNotDefined("--$long");
        }
    }
    ...
    public function getShortOption($char)
    {
        ...
        if ($this->strict) {
            throw new Bull_Cli_Exception_OptionNotDefined("-$char");
        }
    }
    ...
    protected function loadLong($spec)
    {
        ...
        if ($option->isParamRequired() && $value === null) {
            throw new Bull_Cli_Exception_OptionParamRequired();
        }
        
        // if params are rejected and one is present, blow up
        if ($option->isParamRejected() && $value !== null) {
            throw new Bull_Cli_Exception_OptionParamRejected();
        }
