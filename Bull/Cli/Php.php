...
/**
 * 
 * Lets you execute a Bull-based script in a separate PHP process, then get
...
class Bull_Cli_Php
{
    ...
    /**
     * 
     * Runs a file as a Bull script.
     * 
     * @param string $file The file to load as a Bull script.
     * 
     * @return Bull_Php
     * 
     */
    public function runBull($file)
    {
        $code = file_get_contents($file);
        return $this->runBullCode($code);
    }
     ...
     * 
     */
    protected function _buildBullCode($code)
    {
        // the core code
        $code = $this->_buildCode($code);
