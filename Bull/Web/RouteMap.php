...
class Bull_Web_RouteMap
{
     ...
     * Constructor.
     * 
     * @param Bull_Web_RouteFactory $route_factory A factory for creating route objects.
     * 
     * @param array $attach A series of route definitions to be attached to
     * the router.
     * 
     */
    public function __construct(array $attach = null) {
        $this->route_factory = new Bull_Web_RouteFactory();
     ...
     * 
     */
    protected function logRoute(Bull_Web_Route $route)
    {
        $this->log[] = $route;
    }
