 ...
 *
 * {{code: php
 *   $array = Bull_Parse_Spyc::YAMLLoad($file);
 * }}
 *
 * or:
 *
...
class Bull_Parse_Spyc
{
     ...
     * will do its best to convert YAML in a file into a PHP array.  Pretty simple.
     *
     * Usage:
     *
     * {{code: php
     *   $array = Bull_Parse_Spyc::YAMLLoad('lucky.yaml');
     *   print_r($array);
     * }}
     *
     * @access public
