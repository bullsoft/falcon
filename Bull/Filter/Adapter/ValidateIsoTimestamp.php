...
class Bull_Filter_Adapter_ValidateIsoTimestamp extends Bull_Filter_Adapter_Abstract
{
    /**                                                                                     
     *                                                                                      
    ...
    public function __invoke($value)
    {
        ...
        if (! $this->objManager->validateIsoDate($date)) {
            return false;
        }
        ...
        if (! $this->objManager->validateIsoTime($time)) {
            return false;
        }
